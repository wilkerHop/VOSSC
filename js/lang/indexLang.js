var port = {
	...
	saibaMaisBtn1: "Sapato Luxo Ciano: <br><a class='btn btn-primary' data-toggle='modal' href='#modal-id'>Saiba Mais</a>",
	...
	voltar: 'Voltar',
	carrossel: [
		'<span class="azulEscuro">Nova Linha <span class="azulClaro">Ciano</span><br> Confira Já</span>',
		'<span class="branco">Confira nossa nova linha <br> de Tênis</span>',
		'<span class="violeta">Novidade</span><br> <span class="rosa">Linha Magenta</span>',
...
var eng = {
	...
	saibaMaisBtn1: "Know our brand Luxury Cyan:  <br><a class='btn btn-primary' data-toggle='modal' href='#modal-id'>Know More</a>",
	...
	grupo: 'Group DOORS',
	modalContent1: "<img src='img/produtoAzul.gif' class='img-responsive' alt='Image'><p>Synthetic leather shoe, cyan in color, soft plush interior for maximum comfort.</p><p>Designed to fit perfectly to your feet so that you are always comfortable and ready for your day-to-day life.</p><p>Wood flooring for reforestation, light and varnished for greater gloss and conservation of material.</p><p>Weight: 250 grams per piece.</p><p>Package Contents: 1 pair of Light Blue luxury shoes.</p>",
	...
	voltar: 'Back',
	carrossel: [
		'<span class="azulEscuro">New brand <span class="azulClaro">Cyan</span><br> Check it out now</span>',
